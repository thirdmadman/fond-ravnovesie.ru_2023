  ...
  return (
    <footer className='footer'>
      ...
      <div className='footer__contacts'>
        <a className='footer__link-email' href='email:info@fond-ravnovesie.ru'>info@fond-ravnovesie.ru</a>
        <a className='footer__link-phone' href='tel:89313634616'>8 (931) 363-46-16</a>
      </div>
