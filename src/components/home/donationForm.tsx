  ...
  const getMonthlyReminder = () => {
    return (
      <div className=' form-inputs__reminder form-inputs__reminder_monthly'>
        Вы оформляете подписку на ежемесячное пожертвование указанной суммы. Отменить подписку вы можете обратившись на почту
  ...
  const getOnceReminder = () => {
    return (
      <div className='form-inputs__reminder form-inputs__reminder_once'>
        По возникшим вопросам вы можете обратиться на почту <a href='email:info@fond-ravnovesie.ru'>info@fond-ravnovesie.ru</a>
      </div>
    );
  };
    ...
    <form className='donation-form' onSubmit={handleSubmit}>
      ...
      <div className='donation-form__inputs form-inputs'>
        ...
        <div className='form-inputs__reminder form-inputs__reminder_rules'>
          Совершая пожертвование, вы соглашаетесь с условиями <a href='/'>Договора-офертой</a> и <a href='/'>Политики конфиденциальности</a>
        </div>
      </div>
    </form>
  );
