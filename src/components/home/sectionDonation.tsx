    ...
    <section className='section-donation'>
      <div className='section-donation__qr qr-donation'>
        ...
        <div className='qr-donation__subtitle'>
          Мы будем рады небольшой, но ежемесячной помощи - это позволит нам чувствовать себя увереннее и надёжнее строить планы нашей
          работы.
        </div>
        <div className='qr-donation__img-box'>
